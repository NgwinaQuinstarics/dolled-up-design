...
const categories = [
  {
    ...
    items: [
      { name: "Wig Installation (Frontal/Closure)", duration: "2 – 3 hrs", price: "From XAF 5,000" },
      { name: "Custom Wig Making", duration: "By order", price: "From XAF 15,000" },
      { name: "Silk Press / Blowout", duration: "1.5 hrs", price: "From XAF 3,000" },
      { name: "Bridal Updo / Styling", duration: "2 hrs", price: "From XAF 10,000" },
      { name: "Box Braids / Knotless", duration: "4 – 6 hrs", price: "From XAF 6,000" },
    ],
  },
  {
    icon: GiNails,
    ...
    items: [
      { name: "Classic Manicure", duration: "45 min", price: "From XAF 1,500" },
      { name: "Gel Polish (Hands or Feet)", duration: "1 hr", price: "From XAF 2,500" },
      { name: "Gel Extensions / Builder Gel", duration: "1.5 – 2 hrs", price: "From XAF 4,000" },
      { name: "Acrylic Full Set", duration: "2 hrs", price: "From XAF 5,000" },
      { name: "Nail Art (per design)", duration: "+15 min", price: "From XAF 500" },
    ],
  },
  {
    icon: GiLipstick,
    ...
    items: [
      { name: "Soft Glam", duration: "1 hr", price: "From XAF 5,000" },
      { name: "Full Glam", duration: "1.5 hrs", price: "From XAF 8,000" },
      { name: "Bridal Makeup (Trial included)", duration: "2.5 hrs", price: "From XAF 20,000" },
      { name: "Editorial / Photoshoot", duration: "1.5 hrs", price: "From XAF 10,000" },
      { name: "Lashes Application Only", duration: "20 min", price: "From XAF 1,500" },
    ],
  },
  {
    icon: PiEyeBold,
    ...
    items: [
      { name: "Classic Set", duration: "1.5 hrs", price: "From XAF 4,000" },
      { name: "Hybrid Set", duration: "2 hrs", price: "From XAF 6,000" },
      { name: "Volume / Mega Volume", duration: "2.5 hrs", price: "From XAF 8,000" },
      { name: "Refill (within 3 weeks)", duration: "1 hr", price: "From XAF 3,000" },
      { name: "Lash Removal", duration: "30 min", price: "From XAF 1,500" },
    ],
  },
];
